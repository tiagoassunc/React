...
const MediumClap = ({
  ...
  useEffect(() => {
    if (!componetnJustMounted.current && !isControlled) {
...
const ClapIcon = ({ style: userStyles = {}, className: userClassName }) => {
...
const ClapCount = ({ style: userStyles = {}, className: userClassName }) => {
...
const CountTotal = ({ style: userStyles = {}, className: userClassName }) => {
